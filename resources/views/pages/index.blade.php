...
@section('content')
  ...
  <p>This is the my First website:)</p>
  <p><a class="btn btn-primary btn-lg" href="/login" role="button">Login</a>
    ...
    <main class="flex-shrink-0">
        <header class="bg-dark py-5">
            <div class="container-fluid px-5" class="container-fluid px-5" data-aos="fade-up">
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <div class="my-5 text-center text-xl-start">
                            <h1 class="display-5 fw-bolder text-white mb-2">Welcome to My Firstweb</h1>
                            <p class="lead fw-normal text-white-50 mb-4">This is the my First website TechZoo is tech blog
                                site where you can found the blogs related your needs.</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="/posts/index">Get Started</a>
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                <img class="card-img-top"
                                    src="{{ asset('/storage/cover_images/' . $post->cover_image) }}" alt="..." />
                                <div class="card-body p-4">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                    <a class="text-decoration-none link-dark stretched-link" href="/posts/{{ $post->id }}">
